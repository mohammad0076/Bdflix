...
const Recommended = ({ movies }) => {
    return (
        <div className=" carousel-item w-24 md:w-40 lg:w-40 m-1 md:m-2 image-full cursor-pointer transition-transform duration-300 ease-in-out transform hover:scale-110 ">
