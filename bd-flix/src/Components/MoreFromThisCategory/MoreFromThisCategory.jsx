...
const MoreFromThisCategory = ({movies}) => {
    return (
        <div className=" carousel-item w-full md:w-40 lg:w-40 md:m-2 image-full cursor-pointer transition-transform duration-300 ease-in-out transform hover:scale-110 ">
